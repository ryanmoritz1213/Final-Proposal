...
## To Run The Code
In order to run the code all you need to do is either clone the repository or just copy down the code. If you just copy down the code in Project.ipynb, make sure to also run the libraries download in your repository. 