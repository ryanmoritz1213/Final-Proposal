...
# Important Sections
There are only three main parts of this repository: README.md, FinalProject.ipynb and uncertaintysetup.png. The readme give a dense text outline for this project. The finalproject gives a more broad explanation and the code for the simulation along with the external libraries download. The uncertaintysetup is a picture of my physical lab setup.
